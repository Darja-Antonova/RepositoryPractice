...
public class UnityBasicsWorksheet : MonoBehaviour
{
    ...
    // ===== SECTION 2: VARIABLES & PRINTING =====  DONE
    void TryVariables()
    {
    ...
    void TryMath()
    {
        ...
        Debug.Log("Area of rectangle is" + area);

        // EXERCISE: Do the maths and print results
    ...
    void TryWhileLoop()
    {
        ...
        //For loops are good for when you know the number of loops that will occur.
        //While loops are good for when you don't know the number of loops that will occur.
    ...
    void TryInput()
    {
        ...
        //GetKey is for when a key is continuously held down.
        //GetKeyDown is for when a key is pressed once.
    ...
    // ===== SECTION 9: TRANSFORM (Position, Rotation, Scale) =====  DONE
    void TryTransform()
    {
        ...
        // Rotate
        transform.Rotate(0, 90, 0);  // Spin 90 degrees

        // Scale (size)
        transform.localScale = new Vector3(2, 2, 2);  // Double size

        //Position moves a shape to a specified position.
        //Translate moves a shape by a specified amount.
    ...
    void TryArrays()
    {
        ...
        Debug.Log("First colour: " + colours[0]);
        Debug.Log("Last colour: " + colours[4]);
        ...
        int finalScore = scores[0] + scores[1] + scores[2] + scores[3];
    ...
    void TrySwitch()
    {
        ...
        //It would move onto the next case.
        //When you need to compare a single variable or expression against a list of known, specific, and discrete constant values.
